...
@export var water_drag: float = 8.0         # How fast you slow down mid-air

# --- Underwater Jumping Mechanics ---
@export var tail_snap_force: float = -220.0  # The upwards thrust force
@export var water_gravity: float = 500.0     # Light gravity so you float down gently

# --- Weight Penalty Mechanics ---
var items_collected: int = 0
@export var weight_per_item: float = 10.0       # Adds pulling down force per item
@export var penalty_per_item: float = 5.0       # Subtracts jump height/walk speed per item
